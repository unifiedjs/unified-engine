 ...
 * @property {boolean | undefined} [silent]
 *
 ...
 * @property {Array<VFile | URL | string> | undefined} [files]
 ...
 * @property {Preset['settings'] | undefined} [settings]
 ...
 * @property {Preset['plugins'] | undefined} [plugins]
 *   Plugins to use.
 ...
 * @property {Preset | undefined} [defaultConfig]
...
export function engine(options, callback) {
  ...
  settings.files = (options.files || []).map((d) => {
    /** @type {string | VFile} */
    // @ts-expect-error: this ducktypes URLs.
    const result =
      typeof d === 'object' && 'href' in d && !('path' in d)
        ? fileURLToPath(d)
        : d
    return result
  })
