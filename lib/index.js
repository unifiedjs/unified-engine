 ...
 *   `false`).
 * @property {VFileReporterOptions['color'] | undefined} [color=false]
 *   Whether to report with ANSI color sequences (default: `false`).
 ...
 *   Directory to search files in, load plugins from, and more (default:
 *   `process.cwd()`).
 ...
 *   Whether to output a formatted syntax tree (default: `false`).
 *
 ...
 * @property {VFileReporterOptions['quiet'] | undefined} [quiet=false]
 *   Do not report successful files (default: `false`).
 ...
 *   Reporter to use (default: `vfile-reporter`).
 * @property {VFileReporterOptions | undefined} [reporterOptions]
 *   Config to pass to the used reporter (optional).
 * @property {PresetSupportingSpecifiers['settings'] | undefined} [settings]
 *   Configuration for the parser and compiler of the processor (optional).
 * @property {VFileReporterOptions['silent'] | undefined} [silent=false]
 *   Report only fatal errors (default: `false`).
 ...
 *   Stream to read from if no files are found or given (default:
 *   `process.stdin`).
 * @property {NodeJS.WritableStream | undefined} [streamOut]
 *   Stream to write processed files to (default: `process.stdout`).
 ...
 *   Whether to treat output as a syntax tree (default: `options.tree`).
 *
 * @typedef Settings
