...
function create(buf, filePath) {
  ...
  merge(result, self.given, null, Object.assign({}, options, {root: self.cwd}))
...
function merge(target, raw, _, options) {
      ...
      try {
        if (typeof result === 'function') {
          ...
          merge(
            ...
            result,
            value,
            Object.assign({}, options, {root: dirname(fp)})
          )
        }
      } catch (_) {
        throw fault(
...
function reconfigure(entry, value) {
  if (value !== null && typeof value === 'object' && entry[1] !== false) {
